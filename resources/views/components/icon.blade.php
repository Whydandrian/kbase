...
@php
    /**
     * Inline Lucide icons (ported from lucide-react used in the original app).
     * Each entry is the inner markup of the corresponding lucide SVG.
